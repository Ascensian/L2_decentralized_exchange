...
contract QitePool {
    ...
    function addLiquidity(uint256 amountToken1, uint256 amountToken2) external {
        ...
        require(IERC20(token2).transferFrom(msg.sender, address(this),amountToken2), "Transfer of token1 failed");
        // Update the reserves
    ...
    function removeLiquidity(uint amountOfLiquidity) external {
        ...
        require(IERC20(token2).transfer(msg.sender,amountToken2), "Transfer of token1 failed");
        // Update the reserves
        reserve1 -= amountToken1;
        reserve2 -= amountToken2;
        // Update constant k
